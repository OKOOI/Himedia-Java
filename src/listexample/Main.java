...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * students.add(new Student("홍길동", 100, 20, 80)); students.add(new
		 * Student("고길동", 100, 20, 80)); students.add(new Student("신길동", 100, 20, 80));
		 * 
		 * for (Student std : students) { System.out.printf("%s\t%d\t%d\t%d\n",
		 * std.getName(), std.getKorean(), std.getEnglish(), std.getMath()); }
		 */
